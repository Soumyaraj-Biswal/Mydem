...
router.get("/", function(req,res){
    ...
    Campground.find({}).populate("category").exec(function(err, allcampgrounds){
        if(err)
            console.log(err);
        else{
            Category.find({},function(err,category){
                if(err){
                    ...
                    res.render("campgrounds/campground",{camps:allcampgrounds,cat:category,currentUser: req.user});
                }
            });
